<%@ Page Language="C#" MasterPageFile="~/Aurora1.Master" AutoEventWireup="true" CodeBehind="CespPropietario.aspx.cs" Inherits="Aurora.Web.Admin.CespPropietario" %>
...
<br/>
   <dxwgv:ASPxGridView ID="GridGrupos" ClientInstanceName="GridGrupos" runat="server"
        ...
        CssPostfix="Office2003_Olive" KeyFieldName="IDCUENTAESPECIALPROP" OnRowDeleted="GridGrupos_RowDeleted"
        ...
        <SettingsText CommandDelete="Eliminar" CommandEdit="Editar" CommandNew="Nuevo" ConfirmDelete="Está seguro que desea eliminar el registro"
            ...
            PopupEditFormCaption="Nuevo/Edición" Title="CUENTAS ESPECIALES" CustomizationWindowCaption="Seleccione Columna" />
        <TotalSummary>
            <dxwgv:ASPxSummaryItem FieldName="IdCtePropietario" ShowInColumn="IdCtePropietario" ShowInGroupFooterColumn="IdCtePropietario"
                SummaryType="Count" Tag="IdCtePropietario" />
        </TotalSummary>
        <Columns>
            <dxwgv:GridViewDataTextColumn Caption="Codigo" FieldName="IDCUENTAESPECIALPROP" 
                VisibleIndex="0" Name="IDCUENTAESPECIALPROP"
                 ReadOnly="True"   >
                <PropertiesTextEdit>
                    <ValidationSettings>
                    </ValidationSettings>
             ...
             <dxwgv:GridViewDataComboBoxColumn Name="CTECODIGO" FieldName="CTECODIGO" Caption="Tipo Cuenta Especial" VisibleIndex="1">
<PropertiesComboBox ValueType="System.String">
    <ValidationSettings>
                        <RequiredField IsRequired="True" />
                    </ValidationSettings></PropertiesComboBox>
            </dxwgv:GridViewDataComboBoxColumn>
             <dxwgv:GridViewDataTextColumn  Caption="Cantidad Cuotas" FieldName="CEPNUMEROCUOTAS" VisibleIndex="2" PropertiesTextEdit-ValidationSettings-ErrorText="Valor Debe ser Numerico" PropertiesTextEdit-ValidationSettings-RegularExpression-ErrorText="Valor Debe ser Numerico" PropertiesTextEdit-ValidationSettings-RequiredField-ErrorText="Valor Debe ser Numerico">
              <PropertiesTextEdit>
                    <ValidationSettings>
                        <RequiredField IsRequired="True" ErrorText="Valor Numerico" />
                        <RegularExpression  ValidationExpression="\d{1,}" ErrorText="Valor Numerico"  /> 
                    </ValidationSettings>
                </PropertiesTextEdit>
               </dxwgv:GridViewDataTextColumn>
                   <dxwgv:GridViewDataDateColumn Caption="Fecha Primera Cuota" 
            FieldName="CEPFECHAINICIO" VisibleIndex="3">
            ...
            <dxwgv:GridViewCommandColumn ButtonType="Image" Caption="Opciones" VisibleIndex="6"
