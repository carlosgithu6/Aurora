<%@ Page Language="C#" MasterPageFile="~/Aurora1.Master" AutoEventWireup="true" CodeBehind="CuentasFijasPropietario.aspx.cs" Inherits="Aurora.Web.Admin.CuentasFijasPropietario"  %>
...
<br/>
    ...
    <TotalSummary>
        ...
        <Columns>
            ...
            <dxwgv:GridViewDataComboBoxColumn Caption="CUENTAFIJA" FieldName="IDCUENTAFIJA" 
                VisibleIndex="0">
            ...
            <dxwgv:GridViewDataTextColumn Caption="TARIFAACTUAL" FieldName="TARIFAACTUAL" 
                ReadOnly="True" Visible="False" VisibleIndex="2">
            </dxwgv:GridViewDataTextColumn>
            <dxwgv:GridViewDataComboBoxColumn Caption="TIPOCUENTA" FieldName="TIPOCUENTA" 
                VisibleIndex="1">
                <PropertiesComboBox ValueType="System.String">
                </PropertiesComboBox>
            </dxwgv:GridViewDataComboBoxColumn>
            ...
            <dxwgv:GridViewDataDateColumn Caption="FECHAACTUALIZACION" 
                FieldName="FECHAACTUALIZACION" ReadOnly="True" VisibleIndex="4">
                <PropertiesDateEdit DisplayFormatString="dd-MM-yyyy">
                </PropertiesDateEdit>
            </dxwgv:GridViewDataDateColumn>
            <dxwgv:GridViewCommandColumn AllowDragDrop="False" ButtonType="Image" 
                Caption="OPCIONES" VisibleIndex="5">
