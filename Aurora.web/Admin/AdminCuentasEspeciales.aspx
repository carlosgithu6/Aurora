<%@ Page Language="C#" MasterPageFile="~/Aurora1.Master" AutoEventWireup="true" CodeBehind="AdminCuentasEspeciales.aspx.cs"
    Inherits="Aurora.Web.Admin.AdminCuentasEspeciales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
      <dxwgv:ASPxGridView ID="GridGrupos" ClientInstanceName="GridGrupos" runat="server"
        ...
        CssPostfix="Office2003_Olive" KeyFieldName="CTECODIGO" OnRowDeleted="GridGrupos_RowDeleted"
        ...
        OnRowUpdating="GridGrupos_RowUpdating" Width="850px" OnHtmlCommandCellPrepared="GridGrupos_HtmlCommandCellPrepared"
        OnCancelRowEditing="GridGrupos_CancelRowEditing" 
        OnStartRowEditing="GridGrupos_StartRowEditing" 
        onrowvalidating="GridGrupos_RowValidating" 
        onrowcommand="GridGrupos_RowCommand" oninitnewrow="GridGrupos_InitNewRow" onbeforecolumnsortinggrouping="GridGrupos_BeforeColumnSortingGrouping" 
       >
        ...
        <TotalSummary>
            <dxwgv:ASPxSummaryItem FieldName="CTECODIGO" ShowInColumn="CTECODIGO" ShowInGroupFooterColumn="CTECODIGO"
                SummaryType="Count" Tag="Cantidad" />
        </TotalSummary>
        <Columns>
            <dxwgv:GridViewDataTextColumn Caption="Codigo" FieldName="CTECODIGO" 
                VisibleIndex="0" Name="CTECODIGO"
            ...
            <dxwgv:GridViewDataTextColumn Caption="Descripcion" FieldName="CTEDESCRIPCION" 
                VisibleIndex="0" >
                <PropertiesTextEdit>
                    <ValidationSettings>
             ...
             <dxwgv:GridViewDataTextColumn  Caption="Precio" FieldName="CTEPRECIO" 
                VisibleIndex="1" 
...
<dxwgv:GridViewDataDateColumn Caption="Fecha de&lt;br/&gt;creación" 
                FieldName="FECHACREACION" ReadOnly="true"
                VisibleIndex="2">
                <PropertiesDateEdit DisplayFormatString="dd-MM-yyyy" >
                </PropertiesDateEdit>
            </dxwgv:GridViewDataDateColumn>
            <dxwgv:GridViewDataDateColumn Caption="Fecha de&lt;br/&gt;actualización" 
                FieldName="FECHAMODIFICACION" ReadOnly="true"
                VisibleIndex="3">
                <PropertiesDateEdit DisplayFormatString="dd-MM-yyyy" >
                </PropertiesDateEdit>
            </dxwgv:GridViewDataDateColumn>
